...
bool Cube::checkF2Lpair1(){
    if(cube3DArray[0][0][0]==color::White && cube3DArray[3][0][3]==color::Orange 
...
bool Cube::checkTillYellowCross(){
    if(checkF2Lcompletion() && cube3DArray[0][0][1]==color::Yellow && cube3DArray[0][1][2]==color::Yellow
        && cube3DArray[0][2][1]==color::Yellow && cube3DArray[0][1][0]==color::Yellow){
        return true;
    }
    return false;
}
...
bool Cube::checkTillOLL(){
    if(checkTillYellowCross() && cube3DArray[0][0][0]==color::Yellow && cube3DArray[0][0][2]==color::Yellow
        && cube3DArray[0][2][2]==color::Yellow && cube3DArray[0][2][0]==color::Yellow){
        return true;
    }
    return false;
}
...
bool Cube::checkCubeCompletion(){
    if(checkTillOLL() && cube3DArray[1][0][0]==color::Red && cube3DArray[1][0][1]==color::Red &&
        cube3DArray[1][0][2]==color::Red && cube3DArray[2][0][0]==color::Blue && 
        cube3DArray[2][0][1]==color::Blue && cube3DArray[2][0][2]==color::Blue &&
        cube3DArray[3][0][0]==color::Orange && cube3DArray[3][0][1]==color::Orange &&
        cube3DArray[3][0][2]==color::Orange && cube3DArray[4][0][0]==color::Green &&
        cube3DArray[4][0][1]==color::Green && cube3DArray[4][0][2]==color::Green){
            return true;
    }
    return false;
}
